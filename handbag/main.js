...
<div class="collapse navbar-collapse" id="navbarNavAltMarkup">
    <div class="navbar-nav">
        ...
        <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu">
              ...
              <li><a class="dropdown-item" href="../watches/index.html">Watches</a></li>
              <li><a class="dropdown-item" href="index.html">Home Accessories</a></li>
            </ul>
          </li>
    ...
    <div class="navbar-nav">
        ...
        <a class="nav-link text-light" href="../cart.html"><i class="fa-solid fa-cart-shopping"></i> <span class="cart-no"> ${cartNo} </span></a>
